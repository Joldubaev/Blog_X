...
class RegisterView(APIView):
    def post(self, request):
        ...
        if serializer.is_valid(raise_exception=True):
            serializer.save()
            return Response("Are you registered! To activate your account, go to your email.",
...
class LogoutView(APIView):
    ...
    def post(self, request):
        ...
        return Response('You are logged out of your account', status=status.HTTP_200_OK)
...
class ForgotPasswordView(APIView):
    def get(self, request):
        ...
        return Response('You have been sent an activation code to your email.')
